...
CREATE DATABASE local\_realtime\_chat
...
GRANT ALL PRIVILEGES ON local\_realtime\_chat.\* TO 'chatapp'@'localhost';
...
"server=localhost;port=3306;database=local\_realtime\_chat;user=chatapp;password=chatapp123"
